...
public class Utils {
	 ...
	 * We test all the odd numbers as divisors.
	 *
	...
	/**
	 * Find if the given number is prime.
	 * We test all the multiples of 6 +/- 1 as divisors (all primes, except 3, satisfy the condition 6n+/-1)
	 * <p>
	 * This algorithm should be more performant than <code>isPrime(n)</code> (we check 33% of the numbers instead of 50%).
	 *
	 * @param n the value to test
	 * @return True if the given value is prime, false otherwise
	 */
